  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md p-8 rounded-2xl card">
        <h1 className="text-2xl font-bold mb-4 text-violet-800">Sign in to Proctoring</h1>
        <label className="text-sm small">Role</label>
        ...
        <input className="w-full p-3 rounded mb-3 text-black" placeholder="Your email" value={email} onChange={e=>setEmail(e.target.value)} />
        <button onClick={sendOtp} className="w-full py-2 rounded bg-accent">Send OTP</button>
